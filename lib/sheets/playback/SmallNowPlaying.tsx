        ...
        <View style={styles.container}>
            <TouchableOpacity style={styles.left} activeOpacity={.8} onPress={() => changeTab('main')}>
                <View style={styles.left}>
                    <Cover source={{ uri: cover.generateUrl(nowPlaying.coverArt ?? '', { size: 512 }) }} cacheKey={nowPlaying.coverArt ? `${nowPlaying.coverArt}-512x512` : 'empty-512x512'} size={70} radius={12} />
